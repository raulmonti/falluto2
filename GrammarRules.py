...
def FAULTDECL():    return IDENT, ":", 0, EXPRESION, \
                           0, ("=>", NEXTEXPR), "is", [BIZ, STOP, TRANSIENT]

def MODINIT():      return keyword("INIT"), 0, EXPRESION
...
# Booleans
def COMPARISON():   return [ (COMPVAL, re.compile(r"\=|\!\="), COMPVAL)
                           , (MATHEXP, re.compile(r"\>\=|\<\=|\>|\<|\=|\!\="), MATHEXP)
                           ]
