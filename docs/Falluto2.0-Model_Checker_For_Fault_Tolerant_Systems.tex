...
% para la caratula
\usepackage{wrapfig}	% Im\'agenes envueltas en texto (para el t\'itulo)
...
\noindent {\large \bfseries Clasificaci\'on}\\
\indent D.2.4 - Software / Program Verification\\
\indent D.4.5 - Reliability\\
%\indent C.4 - Performance of systems\\

\noindent {\large \bfseries Palabras claves}\\
...
~\\
\newpage
\chapter*{\center{Agradecimientos}}
