#...............................................................................
#   ESTE modulo debera recorrer la estructura de datos resultante de la funcion 
#   'interpret' del modulo interpreter.py. Completara una nueva estructura
#   con los datos obtenidos. Esta estructura tendra la funcion de ordenar de 
#   una manera mas clara los datos para su posterior interpretacion, 
#   validacion, y compilacion al lenguaje de NuSMV.
#...............................................................................
...
#DEBUG
sys.path.append('/home/raul/MiEscritorio/Tesis/Tesis/SVN/trunk/trunk/')
#ENDDEBUG
...
#===============================================================================
# Clase principal (la que retorna el parser al finalizar) Representa de manera 
# ordenada el sistema interpretado por intepret() del modulo interpreter.
#===============================================================================
class System():
    def __init__(self):
        self.modules = []
...
if __name__ == '__main__':
    ...
    try:
        ...
        r = p.parse(interpreter.interpret())
        print "\nThe parsing resulted:", r, "\n"
        print "=================================================================\n"
    except SyntaxError, E:
        print " __3rr0r__ MODULE parse.py massage: going down because of interpreter.py problems :(."
